// POST /api/ai/cause → proxy a cause-only completion to Groq (same cheap,
// fast shape as the title pass, gated by the same key — they run together
// at review load, ahead of the report pass).
...
import { isGroqConfigured, proxyCause } from "../../lib/ai-proxy.js";
