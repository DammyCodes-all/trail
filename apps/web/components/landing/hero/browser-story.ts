...
export function createBrowserStory(rootEl: HTMLElement) {
  ...
  const replayLabel = q<HTMLElement>("[data-replay-label]")[0];
  ...
  timeline
    ...
    .to(panel, { y: 0, opacity: 1, duration: 0.6, ease: "power3.inOut" }, 4.0)
    ...
    .to(panel, { y: 16, opacity: 0, duration: 0.5, ease: "power3.inOut" }, 10.5)
