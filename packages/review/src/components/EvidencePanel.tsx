...
import {
  ...
  CollapsibleContent,
  CollapsibleTrigger,
} from "@trail/review/ui/collapsible";
import { prettyBody } from "@trail/review/lib/pretty";
import { severityOfStatus } from "@trail/review/lib/summary";
import type { ConsoleEvent, NetEvent, StoredEvent } from "@trail/review/lib/types";
