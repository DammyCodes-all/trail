  ...
  (
    ...
    return (
      <button
        ref={innerRef}
        className={cn(
          "bg-primary text-primary-foreground relative flex cursor-pointer items-center justify-center rounded-lg px-4 py-2 text-center disabled:pointer-events-none disabled:opacity-50",
          className
        )}
        style={
          {
